...
from GUI.gui2.scrolledtext import ScrolledText      # наш, не из биб лиотеки Python
...
class SimpleEditor(ScrolledText):                   # доп. ф-ции смотрите в PyEdit
    ...
    def onSave(self):
        ...
        if filename:
            alltext = self.get_text()               # от начала до конца
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        SimpleEditor(file='jack.txt').mainloop() # или нет: пустой виджет
